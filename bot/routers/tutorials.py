...
TUTORIAL_TEXTS = {
    "android": """باید از برنامه‌هایی مانند DNS Changer یا Intra استفاده کنید و آدرس‌های عددی (Primary/Secondary) را ست کنید.

🔴 توجه حیاتی: پس از تنظیم دی‌ان‌AS، حتماً مجدد روی دکمه ثبت آیپی در پیام تحویل اشتراک خود کلیک کنید تا دسترسی شما فعال شود.""",
...
🔴 توجه حیاتی: پس از تنظیم دی‌ان‌اس، حتماً مجدد روی دکمه ثبت آیپی در پیام تحویل اشتراک خود کلیک کنید تا دسترسی شما فعال شود.""",
...
🔴 توجه حیاتی: پس از تنظیم دی‌ان‌اس، حتماً بدون فیلترشکن و پروکسی تلگرام مجدد روی دکمه ثبت آیپی در پیام تحویل اشتراک خود کلیک کنید تا آی‌پی سیستم شما فعال شود.""",
